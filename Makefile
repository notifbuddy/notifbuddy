.PHONY: help generate gen-go gen-ts dev dev-backend dev-waitlist dev-frontend dev-landing dev-docs build build-backend build-waitlist build-frontend build-landing install clean
